...
//加载开始
    ...
    private onloadmusic(event:RES.ResourceEvent):void  {
        ...
        var hailoader:egret.URLLoader = new egret.URLLoader();
...
//第三页开始
        ...
        var banruo:egret.Bitmap = this.createBitmapByName("banruo_jpg");
        ...
        var santi:egret.Bitmap = this.createBitmapByName("santi_jpg");
        ...
        var banruoBIG:egret.Bitmap = this.createBitmapByName("banruo_jpg");
        ...
        function onTouchbanruobig(event:egret.Event){
        ...
        function onTouchbanruosmall(event:egret.Event){
        ...
        var santiBIG:egret.Bitmap = this.createBitmapByName("santi_jpg");
        ...
        function onTouchsantibig(event:egret.Event){
            page3.addChild(pictureMask);
        ...
        function onTouchsantismall(event:egret.Event){
            page3.removeChild(pictureMask);
...
//第四页开始
    ...
    var page4 = new egret.DisplayObjectContainer();
        ...
        var haishang:egret.Bitmap = this.createBitmapByName("haishang1_png");
...
//音频播放
        ...
        hailoader.dataFormat = egret.URLLoaderDataFormat.SOUND;
        hailoader.load(new egret.URLRequest("resource/haishang.mp3"));
        hailoader.addEventListener(egret.Event.COMPLETE, function hailoadOver(event:egret.Event) {
            haisign = true;
        }, this);
...
//播放按钮开始
        ...
        function onTouchhaishang(event:egret.Event){
            ...
            var sound:egret.Sound = hailoader.data;
            ...
            if(haisign == true){
                ...
                var haiplayanime:Function = function () {
...
//第五页开始
        ...
        var changeqinshi:Function = function () {
        ...
        var changebanben:Function = function () {
        ...
        var changeduannao:Function = function () {
        ...
        var qinshi:egret.Bitmap = this.createBitmapByName("qinshi_jpg");
        ...
        var banben:egret.Bitmap = this.createBitmapByName("banben_jpg");
        ...
        var duannao:egret.Bitmap = this.createBitmapByName("duannao_jpg");
